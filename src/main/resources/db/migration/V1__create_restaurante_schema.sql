...
CREATE INDEX idx_pedidos_itens_pedido ON pedido_itens(pedido_id);
CREATE INDEX idx_pedidos_itens_produto ON pedido_itens(produto_id);
CREATE INDEX idx_pedidos_itens_status ON pedido_itens(status);

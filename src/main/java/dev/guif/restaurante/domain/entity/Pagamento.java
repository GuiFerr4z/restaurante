package dev.guif.restaurante.domain.entity;

import dev.guif.restaurante.domain.enums.FormaPagamento;
import dev.guif.restaurante.domain.enums.StatusPagamento;
